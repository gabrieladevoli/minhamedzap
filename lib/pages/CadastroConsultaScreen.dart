...
class CadastroConsultaScreen extends StatefulWidget {
  ...
  final Map<String, String>? consultaExistente;

  const CadastroConsultaScreen({
    super.key,
    this.consultaExistente,
  });
...
class _CadastroConsultaScreenState extends State<CadastroConsultaScreen> {
  ...
  void initState() {
    ...
    if (widget.consultaExistente != null) {

      _tipoConsultaSelecionado =
          widget.consultaExistente!['tipo'];

      _localSelecionado =
          widget.consultaExistente!['local'];
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  initialValue: _tipoConsultaSelecionado,
  ...
  if (_tipoConsultaSelecionado == null ||
  ...
  InputDecoration _estiloDecoracaoCampo() {
    ...
    void mainCadastroConsultaScreen() {
      runApp(const CadastroConsultaScreen());
    }